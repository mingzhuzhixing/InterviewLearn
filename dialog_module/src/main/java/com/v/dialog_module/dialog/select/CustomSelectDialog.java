package com.v.dialog_module.dialog.select;
...
import com.v.dialog_module.dialog.base.BaseDialog;

import java.util.List;

/**
 * ClassName: CustomSelectDialog
 * Description:
 *
 * @author zhuming
 * @package_name com.v.dialog_module.dialog.select
 * @date 2022/1/27 5:19 下午
 */
public class CustomSelectDialog extends BaseDialog<CustomSelectDialog> {
