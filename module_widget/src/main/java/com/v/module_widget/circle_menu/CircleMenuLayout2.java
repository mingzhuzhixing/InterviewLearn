...
public class CircleMenuLayout2 extends ViewGroup {
     ...
     * 设置菜单条目的图标和文本
     */
    public void setMenuItemIconsAndTexts(int[] resIds, String[] texts, int startAngle) {
        mItemImgs = resIds;
        mItemTexts = texts;
    ...
    private void addMenuItems() {
        ...
        for (int i = 0; i < mMenuItemCount; i++) {
            final int j = i;
            View view = mInflater.inflate(R.layout.circle_menu_item_2, this, false);
    ...
    public void removeAllChildView() {
        ...
        for (int i = 0; i < count; i++) {
            child = getChildAt(i);
            if (child != null && child.getId() == R.id.id_circle_menu_item_center) {
                break;
            }
        }
        removeAllViews();
