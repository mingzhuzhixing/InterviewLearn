 ...
 * </pre>
 */
public class CircleMenuCCBLayout extends ViewGroup {
    private int mRadius;
    /**
     * 该容器内child item的默认尺寸
     */
    ...
    private int mMenuItemLayoutId = R.layout.circle_menu_ccb_item;

    public CircleMenuCCBLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 无视padding
        setPadding(0, 0, 0, 0);
    }
