 ...
 * 建设银行 圆形菜单
 */
public class CircleMenu2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circle_menu_2);
        ...
        mCircleMenuLayout.setOnMenuItemClickListener(new CircleMenuLayout2.OnMenuItemClickListener() {
            ...
            public void itemClick(View view, int pos) {
                Toast.makeText(CircleMenu2Activity.this, mItemTexts[pos], Toast.LENGTH_SHORT).show();
            }

            @Override
            public void itemCenterClick(View view) {
                Toast.makeText(CircleMenu2Activity.this, "you can do something just like ccb  ", Toast.LENGTH_SHORT).show();
            }
        });
    }
