...
public class ReboundHScrollView2 extends NestedScrollView {
    private static final int MAX_SCROLL = 200;
    private static final float SCROLL_RATIO = 0.5f;// 阻尼系数

    public ReboundHScrollView2(Context context) {
        super(context);
    }

    public ReboundHScrollView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ReboundHScrollView2(Context context, AttributeSet attrs, int defStyle) {
