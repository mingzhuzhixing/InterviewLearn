...
public class SelectTimePopupWindow extends PopupWindow {
    ...
    private ScrollerNumberPicker snp_popupwindow_year, snp_popupwindow_month, snp_popupwindow_day;
    ...
    public SelectTimePopupWindow(Context context, OnClickListener itemsOnClick) {
        ...
        tv_location_cancel =  mView.findViewById(R.id.tv_location_cancel);
        tv_location_submit =  mView.findViewById(R.id.tv_location_submit);
...
//		this.setAnimationStyle(R.style.AnimBottom);
    ...
    private void initData() {
        ...
        // 放数据
        snp_popupwindow_year.setData(mProvinceList);
        // 默认选择的位置
    ...
    private void updateProvince() {
        ...
        snp_popupwindow_month.setData(mCityList);
