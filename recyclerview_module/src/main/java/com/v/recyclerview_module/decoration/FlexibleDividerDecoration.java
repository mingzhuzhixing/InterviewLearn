package com.v.recyclerview_module.decoration;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected int lastDivider;
    protected boolean mShowFirstDivider;
    protected int firstDivider;
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        firstDivider = builder.firstDiver;
        mShowLastDivider = builder.mShowLastDivider;
        lastDivider = builder.lastDivider;
    ...
    public static class Builder<T extends Builder> {
        ...
        public T showFirstDivider() {
            return showFirstDivider(0);
        }

        public T showFirstDivider(@DimenRes int sizeId) {
            mShowFirstDivider = true;
            firstDiver = sizeId != 0 ? mResources.getDimensionPixelSize(sizeId) : 0;
            return (T) this;
        }

        public T showLastDivider() {
            return showLastDivider(0);
        }

        public T showLastDivider(@DimenRes int resId) {
            mShowLastDivider = true;
            lastDivider = resId != 0 ? mResources.getDimensionPixelSize(resId) : 0;
            return (T) this;
        }
