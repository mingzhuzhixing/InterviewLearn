...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    protected void setItemOffsets(Rect outRect, int position, RecyclerView parent) {
        ...
        if (isReverseLayout(parent)) {
            ...
            int top = 0, bottom = 0;
            if (itemCount == 1) {
                final int itemViewType = parent.getAdapter().getItemViewType(0);
                ...
                if (mShowFirstDivider) {
                    ...
                    top = firstDivider == 0 ? getDividerSize(position, parent) : firstDivider;
                }
                if (mShowLastDivider) {

                    bottom = lastDivider == 0 ? getDividerSize(position, parent) : lastDivider;
                }
            } else {
                if (position == 0) {
